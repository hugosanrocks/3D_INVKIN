       ...
       open(iunit,file='dat/ttimes.info',status='old',action='read')
       siz = nsubf
       sizint = nsubfint
...
!         write(44,*) snapint(28,12)
       ...
       !Read the slip solution
       open(iunit,file='dat/ttimesinterp.info',status='unknown')
       do i = 1, sizint
