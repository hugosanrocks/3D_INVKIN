...
#legends
escal=graphics/escala
escal2=graphics/escala2
...
#plot legend
#gmt psxy $escal -R$region -J$proj -W0.5p,$red,- -O -K -V >> $out
#gmt psxy $escal2 -R$region -J$proj -W2 -O -K -V >> $out
...
#gmt psxy $syn2 -R$region -J$proj -h$nhead -W2/$red -O -K >> $out
