function [UXW1,SXW1,UXW2,SXW2,UKW0]=calcul_US_DWN_PSV_Ncapas_HS(para,xr,zr0,izr0,salu,sals,coordf,fij,DWN)
...
UXW1        = zeros(2,sum(salu),nxs);
SXW1        = zeros(2,2,sum(sals),nxs);
UXW2        = zeros(2,sum(salu),nxs);
SXW2        = zeros(2,2,sum(sals),nxs);
            ...
            for irx=1:nrecx
                ...
                if salu(ir)==1
                    ...
                    if para.DWNnbptkx/2+1<=para.nkmaxKW
                        UKW0                = sqrt(abs(U1KW0(1:nk2)).^2+abs(U2KW0(1:nk2)).^2);
                    end
                end
        ...
        for ixs=1:nxs
            ...
            for irx=1:nrecx
                ...
                if salu(ir)==1
                    ...
                    if para.DWNnbptkx/2+1<=para.nkmaxKW
                        UKW0                    = UKW0+sqrt(abs(U1KW0(1:nk2)).^2+abs(U2KW0(1:nk2)).^2);
                    end
                end
