function Gij=Gij_3D_r_small_FP(coord,xs,ys,zs,jjpb,ks,kp,gaussian,C)
% trata el calculo de la contribution de una fuente real en xs,ys,zs
% sobre un elemento de colocacion "centrado" en xj,yj,zj,
% este elemento esta mas cercano que dr a xs,ys,zs
