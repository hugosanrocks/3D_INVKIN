function Sij = Sij_PSV(rij,g,ks,kp,C)
% Función de Green de esfuerzos
...
Sij = zeros(3,2,length(rij)); % (sxx|sxz|szz,Fza x|z,:)
Sij(1,1,:) = S1(1,1,:);  Sij(1,2,:) = S2(1,1,:);
Sij(2,1,:) = S1(1,2,:);  Sij(2,2,:) = S2(1,2,:);
Sij(3,1,:) = S1(2,2,:);  Sij(3,2,:) = S2(2,2,:);
end