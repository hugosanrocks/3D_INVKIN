function det0=mode_Love_mex(DWN,ncapas,h,vS,C66)
...
for ic=1:ncapas
    ...
    k1(:,ic)= sqrt(complex(k2.^2-ksi.^2)); %k1S%%%%%%% attention c est a l envers (*1i)
    k1(k1(:,ic)==0,ic)=1e-10;
end
...
S12     = k1(:,ic)*C66(ic); %sigma_zy sigma12
kh      = k1(:,ic)*h(ic);
...
% det0 = squeeze(G1(1,1,:))+squeeze(1./k1(:,ic)/C66(ic)).*squeeze(G1(2,1,:));
det0 = P11+1./k1(:,ic)/C66(ic).*P21;
