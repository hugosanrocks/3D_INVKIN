function [UXW,SXW]=calcul_US_DWN_SH_Ncapas_HS_incOP_corr(para,xr,zr0,izr0,salu,sals,coordf,kxk,kzsigno)
...
ncapas      = para.nsubmed;
A_DWN       = zeros(2*(ncapas-1)+1,2*(ncapas-1)+1);
nrec        = length(xr);
nrecz       = length(zr0);
