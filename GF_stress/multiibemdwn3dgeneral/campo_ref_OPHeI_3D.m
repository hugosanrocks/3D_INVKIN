function [u,t]=campo_ref_OPHeI_3D(xs,ys,zs,coord,kpi,ksi,kri,C,tipo_onda,kxk,kyk)
...
if tipo_onda==1
    ...
    upi     = [kx ky -kzP]/kpi;%incidencia hacia z<0
    ...
    kzS     = 0;
elseif tipo_onda==2
    %incidencia de ondas SV (plano r z)
    u_incS  = zeros(3,n);
    ...
    usi     = [kzS*kx/kr kzS*ky/kr kr]/ksi;
    ...
    kzP     = 0;
elseif tipo_onda==3
    %incidencia de ondas SH (plano r th)
    u_incS  = zeros(3,n);
...
if tipo_onda==1 || tipo_onda==2
    ...
    du2dx2=-1i*ky *u(2,:);
    du3dx2=-1i*ky *u(3,:);
    du1dx3= 1i*kzP*u_incP(1,:) + 1i*kzS*u_incS(1,:); %du1/dx3
    du2dx3= 1i*kzP*u_incP(2,:) + 1i*kzS*u_incS(2,:);
    du3dx3= 1i*kzP*u_incP(3,:) + 1i*kzS*u_incS(3,:);
else
