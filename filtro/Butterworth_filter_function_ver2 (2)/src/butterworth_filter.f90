...
#include "global.h"
    ...
    ! Local variables
    !-----------------------
    MYFLOAT, DIMENSION(:), POINTER :: ftseries
    MYFLOAT C(5,10), D(2,10)     
    MYFLOAT Tg
    INTEGER NSections
    INTEGER ii   
    ...
    CALL MEMORY_STAT(SIZE(ftseries), 'ftseries', REAL_SIZE, ALLOC, 1) 
    ...
    CALL MEMORY_STAT(SIZE(ftseries), 'ftseries', REAL_SIZE, DEALLOC, 1)
    DEALLOCATE(ftseries)   
